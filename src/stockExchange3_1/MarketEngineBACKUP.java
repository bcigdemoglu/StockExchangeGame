...
public class MarketEngineBACKUP {
	...
	public MarketEngineBACKUP() throws IOException {
		bidVal = new LinkedList<Double>();
		askVal = new LinkedList<Double>();
		BufferedReader br = new BufferedReader(new FileReader("sekerbankUsdSatis.txt"));
		String sCurrentLine;
