...
public class Player {
	...
	public String startGame() {
		return String.format("%10.2f", startTRY) + " USD  and" + String.format("%10.2f", startUSD) + " EUR.";
	}
	
	public String endGame(double askVal, double bidVal) {
		return String.format("%10.2f", calculateTRY(bidVal)) + " USD  or" + String.format("%10.2f", calculateUSD(askVal)) + " EUR.";
	}
